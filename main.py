...
green_model_path = os.path.join(BASE_DIR, "green_model.pth")
sequencer_path = os.path.join(BASE_DIR, "sequencer_model.pth")

green_model = GreenTimePredictor()
green_model.load_state_dict(torch.load(green_model_path, map_location="cpu"))
green_model.eval()

sequencer = Sequencer()
sequencer.load_state_dict(torch.load(sequencer_path, map_location="cpu"))
sequencer.eval()
